...
const CarCard = ({ car }) => {
    ...
    return (
        <div onClick={() => { navigate(`/car-details/${car._id}`); scrollTo(0, 0) }} className='group h-full flex flex-col rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer bg-white'>
            ...
            <div className='relative h-48 overflow-hidden'>
                ...
                <div className='absolute border-0 right-4 bottom-4 bg-black/80 backdrop-blur-sm text-white px-3 py-2 rounded-lg'>
