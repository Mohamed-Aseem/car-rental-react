  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
      <div className='group relative'>
        <label htmlFor="image">
          <img src={image ? URL.createObjectURL(image) : user?.image || "https://cdn.pixabay.com/photo/2023/02/18/11/00/icon-7797704_960_720.png"} alt="Profile Image" className='h-9 md:h-20 w-9 md:w-20 rounded-full mx-auto' />
      ...
      {image && (
        <button className='absolute top-0 right-0 flex p-2 gap-1 bg-primary/10 text-primary cursor-pointer' onClick={updateImage}>Save <img src={assets.check_icon} alt="Icon" width={13} /></button>
      )}
