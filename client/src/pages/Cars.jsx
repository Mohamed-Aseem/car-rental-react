    ...
    <div>
      ...
      >
        ...
        >
          ...
          <img src={assets.filter_icon} alt="Search Icon" className='w-4.5 h-4.5 ml-2' />
        </motion.div>
      </motion.div>
      ...
      >
        ...
        <div className='grid grid-cols-1 items-stretch sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-4 xl:px-20 max-w-7xl mx-auto'>
